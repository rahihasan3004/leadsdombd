    ...
    <section className="relative overflow-hidden bg-[#FAFAFA]">
      ...
      <div className="max-w-6xl mx-auto px-4 my-20 relative">
        <div className="bg-[#0B0F17] border border-neutral-800 rounded-[28px] md:rounded-[36px] py-16 md:py-20 px-6 md:px-12 text-center relative overflow-hidden shadow-none">
          ...
          <Link
            href={ctaHref}
            className="inline-flex items-center justify-center px-7 py-3 rounded-full bg-white text-neutral-900 font-semibold text-sm hover:bg-neutral-100 hover:scale-[1.02] transition-all duration-200 relative z-10 shadow-md"
          >
