...
const ACTIVE_STATES = [
  { code: "FL", name: "Florida", fill: "#14A800" },
  { code: "CA", name: "California", fill: "#14A800" },
  { code: "TX", name: "Texas", fill: "#14A800" },
  { code: "NY", name: "New York", fill: "#14A800" },
  { code: "AZ", name: "Arizona", fill: "#14A800" },
];
    ...
    <div className="rounded-xl border-0 bg-slate-50 p-6 dark:bg-slate-900 shadow-none">
      ...
      <div className="mb-4 flex justify-center">
        <svg
          ...
          aria-label="US map showing 5 active states: Florida, California, Texas, New York, Arizona"
        >
          <g>
            {/* Base grey fill for all states */}
            ...
            <path d="M 60 150 L 100 140 L 120 160 L 130 190 L 110 210 L 80 200 L 60 180 Z" fill="#14A800" fillOpacity="0.2" stroke="#14A800" strokeWidth="1.5" />
            
            {/* Texas highlighted */}
            <path d="M 350 280 L 420 260 L 450 280 L 460 320 L 440 360 L 410 370 L 360 350 L 340 310 Z" fill="#14A800" fillOpacity="0.2" stroke="#14A800" strokeWidth="1.5" />
            <path d="M 350 280 L 370 250 L 400 240 L 420 260 Z" fill="#14A800" fillOpacity="0.2" stroke="#14A800" strokeWidth="1.5" />
            
            {/* Florida highlighted */}
            <path d="M 620 370 L 650 360 L 670 390 L 680 430 L 660 470 L 640 480 L 620 450 L 610 400 Z" fill="#14A800" fillOpacity="0.2" stroke="#14A800" strokeWidth="1.5" />
            
            {/* New York highlighted */}
            <path d="M 680 120 L 710 110 L 720 130 L 710 150 L 730 160 L 730 180 L 700 190 L 680 180 L 670 150 Z" fill="#14A800" fillOpacity="0.2" stroke="#14A800" strokeWidth="1.5" />
            
            {/* Arizona highlighted */}
            <path d="M 200 220 L 240 200 L 260 210 L 270 240 L 260 270 L 230 280 L 210 260 Z" fill="#14A800" fillOpacity="0.2" stroke="#14A800" strokeWidth="1.5" />
      ...
      <div className="space-y-2">
        {ACTIVE_STATES.map((state) => (
          ...
          >
            ...
            <span className="text-xs font-semibold text-[#14A800]">200 Leads</span>
          </div>
        ))}
      </div>
    </div>
